...
const en = {
  ...
  auth: {
    ...
    removeAccount: "Remove {username}",
    removeAccountConfirm: "Remove GitHub account {username}?",
    fileStorageWarning:
      "The system keychain is unavailable; this token is stored in a user-only file.",
...
const ja: Messages = {
  ...
  auth: {
    ...
    signedIn: "ログイン中",
    signedOut: "未ログイン",
    accounts: "GitHubアカウント",
    addAccount: "アカウントを追加",
    removeAccount: "{username} を削除",
    removeAccountConfirm: "GitHubアカウント {username} を削除しますか？",
    fileStorageWarning:
      "システムのキーリングを利用できないため、トークンはユーザー専用ファイルに保存されています。",
