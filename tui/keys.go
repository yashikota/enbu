...
type keyMap struct {
	Up, Down, Add, Edit, Delete, Switch, Refresh, Pull, Export key.Binding
...
var keys = keyMap{
	...
	Refresh: binding("r"), Pull: binding("p"), Export: binding("x"), Enter: binding("enter"), Escape: binding("esc"),
